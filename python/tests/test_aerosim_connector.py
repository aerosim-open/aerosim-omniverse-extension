...
import omni.usd
import aerosim.omniverse.extension


class TestUsdExample(omni.kit.test.AsyncTestCase):
    async def setUp(self):
        # Cache the example usd interface.
        self.aerosim_connector = aerosim.omniverse.extension.get_aerosim_connector()
    ...
    async def tearDown(self):
        ...
        self.aerosim_connector = None

    async def test_create_prims(self):
        self.aerosim_connector.initialize_scene_graph()
